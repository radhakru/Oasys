...
public class ListOfPaddyForEditDrcs {

	public WebDriver ldriver;
	public Actions action;
	public ListOfPaddyForEditDrcs(WebDriver rdriver) {
	...
	private By editButton = By.xpath("//table[@id='datatable']/tbody/tr[1]/td[6]/button");
	...
	private By district=By.xpath("//*[@id='district1']");
	private By circle=By.xpath("//*[@id='circle1']");
	private By block=By.xpath("//*[@id='block1']");
...
//		select.selectByVisibleText(mes);
	...
	public void update_District() {
		ldriver.findElement(district).click();
		ldriver.findElement(district).sendKeys("BALANGIR");
	}
	public void update_Circle() throws InterruptedException {
		ldriver.findElement(circle).click();
		Thread.sleep(2000);
		ldriver.findElement(circle).sendKeys("Gudvella");
		
	}
	public void update_Block() {
		ldriver.findElement(block).click();
		ldriver.findElement(block).sendKeys("Titilagarh");
	}
